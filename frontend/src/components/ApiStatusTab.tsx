...
import { SOUDMUSIC_NEXT_SOURCES } from "@/lib/api-status";
...
export function ApiStatusTab() {
    ...
    const isCheckingNext = SOUDMUSIC_NEXT_SOURCES.some((source) => nextStatuses[source.id] === "checking");
    ...
    return (<div className="space-y-6">
      <div className="space-y-4">
        <div className="flex items-center justify-between gap-3">
          <h3 className="text-sm font-semibold tracking-tight">SoudMusic</h3>
      ...
      <div className="space-y-4">
        <h3 className="text-sm font-semibold tracking-tight">SoudMusic Next</h3>

        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5">
          {SOUDMUSIC_NEXT_SOURCES.map((source) => {
